const input = `LLLLLLLLLL.LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL.LLLLLL.LLLLLLLL.LLLLLL.LLLLLLLLLLLLL.LLLLLLLL
...
export default input.split('\n').map((value) => value.replace(/(\r\n|\n|\r)/gm, "")).map(value => value.split('')).map((rowArray) => rowArray.map(seat => seat === '.' ? ' ' : seat))